...
public class TravelUtilityBags {

	WebDriver driver;

	public TravelUtilityBags(WebDriver driver) {
		this.driver = driver;
	...
	@FindBy(linkText = "Backpack")
	private WebElement BackpackElement;

	@FindBy(linkText = "Duffle Bag & Strolleys")
	private WebElement BagtrolleysElement;
	...
	public WebElement getBlueElement() {
		return blueElement;
	}
	...
	public void Test1() {
		...
		actions.moveToElement(BackpackElement).click().perform();
	...
	public void Test2() {
		...
		actions.moveToElement(shopingCategoryElement).perform();
		actions.moveToElement(footBagsElement).perform();
		actions.moveToElement(BagtrolleysElement).click().perform();
